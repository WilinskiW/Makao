...
public class GUIparams {
   ...
   public static final float CHOOSER_CARD_X_POS = CHOOSER_WINDOW_X_POS + 65;
   public static final float CHOOSER_CARD_Y_POS = CHOOSER_WINDOW_Y_POS + 8;
   public static final float ARROW_BUTTON_WIDTH = 48;
   public static final float ARROW_BUTTON_HEIGHT = 64;
   public static final float PUT_X_POS = WIDTH / 2f-50;
   public static final float PUT_Y_POS = HEIGHT / 2f - 40;
